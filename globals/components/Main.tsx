...
import PageWrap from "globals/PageWrap"
...
const Main = () => {
    ...
    const handleExtract = () => {
        ...
        alert("Extracting email data...")
    }

    const handleCheck = () => {
         // TODO: Implement phishing detection functionality
        if (!emailData.body) {
            alert("Please enter email content")
            return
        }
        alert(`Email Content: ${emailData.body}`)
    }
                ...
                <main className="flex-1 flex flex-col justify-center items-center w-full gap-4">
                    ...
                    <div className="flex flex-col gap-2 justify-center items-center">
                        <div className="flex flex-row gap-2">
                            <Button variant="primary" size="small" onClick={handleExtract}>Extract</Button>
